...
public class player_movement : MonoBehaviour {
    ...
    public Transform GroundChecker; //an invisible point in space. We use it to see if the player is touching the ground
    ...
    void FixedUpdate()
    {
        grounded = Physics2D.OverlapCircle(GroundChecker.position, groundCheckRadius, whatIsGround); //this statement calculates when 
